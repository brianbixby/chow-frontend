...
class RecipeContainer extends React.Component {
  constructor(props){
    super(props);
    this.state = {userSuccess: false, recipeError: false, userSuccessMessage: '', pageBottom: false};
  }
  ...
  componentWillUnmount() {
    this.setState({ userSuccess: false, recipeError: false, pageBottom: false});
    document.removeEventListener('scroll', this.trackScrolling);
  }
 
  handleBoundFavoriteClick = () => {
    if (this.props.userAuth) {
      let found = this.props.favorites.filter(fav => fav.uri == this.props.recipe.uri);
      if (found.length) {
        ...
        return this.props.favoriteFetch(this.props.recipe)
          .then(() => {
                  ...
                  <div className='irHead'>
                    <div className='irImgContainerDisplaySmall'>
                      <div className='irImgContainerInnerWrapper'>
                        ...
                        <div title={likedRecipe ? "Remove this recipe from your favorites" : "Add this recipe from your favorites"} className={classToggler({likeButton: true, hideLike: !this.props.userAuth, likedRecipe: likedRecipe})} onClick={this.handleBoundFavoriteClick}></div>
                      </div>
                    </div>
